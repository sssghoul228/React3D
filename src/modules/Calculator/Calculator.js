import {Complex, Vector, Matrix, Polynominal} from "./class";
import {ComplexCalculator, VectorCalculator, MatrixCalculator} from "./calculators";
import PolynominalCalculator from "./PolynominalCalculator";
...
export default class Calculator{
    ...
    complex(re, im) {
      ...
      get(elem) {
        ...
        if (elem instanceof Polynominal) return new PolynominalCalculator(this.get(elem.values[0]));
